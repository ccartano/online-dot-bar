...
exports.CocktailsModule = CocktailsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([cocktail_entity_1.Cocktail])],
        controllers: [cocktails_controller_1.CocktailsController],
        providers: [cocktails_service_1.CocktailsService],
        exports: [cocktails_service_1.CocktailsService],
    })
], CocktailsModule);
